...
- Produto
 ...
 - Telas & Segurança
	...
	- Catálogo (Geral): [`catalogo/catalogo-telas.md`](catalogo/catalogo-telas.md) — canônico em `telas/`
	- Matriz (Geral): [`catalogo/matriz-permissoes.md`](catalogo/matriz-permissoes.md) — canônico em `telas/`
- Banco de Dados
