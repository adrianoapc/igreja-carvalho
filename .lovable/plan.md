...
# Plano: Criar Documentação da Integração de Lotes nos Chatbots WhatsApp

## Objetivo

Criar o arquivo `docs/adr/ADR-016-integracao-lotes-chatbots-whatsapp.md` documentando o plano técnico para integrar o sistema de lotes (`evento_lotes`) nos chatbots de inscrição via WhatsApp.
...
```markdown
# ADR-016: Integração de Lotes nos Chatbots WhatsApp
...
const mensagemResposta = loteAtivo?.valor > 0
...
| Arquivo | Descrição |
|---------|-----------|
| `docs/adr/ADR-016-integracao-lotes-chatbots-whatsapp.md` | Documentação completa do plano |
