-- Corrigir função gerar_candidatos_conciliacao para usar subtração de datas corretamente
-- Quando subtraímos duas datas em PostgreSQL, o resultado é um INTEGER (dias), não INTERVAL
  ...
  WITH candidatos_1x1 AS (
    SELECT 
      ...
      (
        ...
        END +
        -- Data (30%) - subtração de datas retorna dias diretamente
        CASE 
