          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {jornadas.map((jornada) => {
              ...
              const concluidos = inscricoes.filter(
                (i: { concluido?: boolean }) => i.concluido
              ).length;
              ...
              return (
                <Card
                  ...
                  onClick={() => navigate(`/ensino/jornadas/${jornada.id}`)}
                >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1 min-w-0">
                          <div
                            ...
                            style={{
                              backgroundColor: jornada.cor_tema || "#3b82f6",
                            }}
                          />
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {(() => {
                            ...
                            return (
                              <Badge
                                className={`text-xs font-normal shrink-0 border ${tipo.color} flex items-center gap-1`}
                              >
                                {tipo.icon && tipo.icon}
                                {tipo.label}
                              </Badge>
