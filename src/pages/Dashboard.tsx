      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-4 lg:gap-6">
        <Card className="shadow-soft">
          ...
          <CardContent className="space-y-3 md:space-y-4 p-4 md:p-6 pt-0">
            ...
            time: "10:00",
            type: "Culto de Celebração"
          }].map((culto, index) => <div key={index} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 md:p-4 rounded-lg gap-2 sm:gap-0 bg-[#eff0cf]">
                <div>
        ...
        <Card className="shadow-soft">
          ...
          <CardContent className="space-y-3 md:space-y-4 p-4 md:p-6 pt-0">
            ...
            time: "Há 1 dia"
          }].map((pedido, index) => <div key={index} className="flex items-start gap-2 md:gap-3 p-3 md:p-4 rounded-lg bg-[#eff0cf]">
