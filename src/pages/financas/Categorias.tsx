  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div className="flex flex-col gap-3">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-foreground">Categorias e Subcategorias</h1>
      ...
      <Card className="shadow-soft">
        <CardHeader className="p-4 md:p-6">
          <CardTitle className="text-lg md:text-xl">Categorias de Entradas</CardTitle>
        </CardHeader>
      ...
      <Card className="shadow-soft">
        <CardHeader className="p-4 md:p-6">
          <CardTitle className="text-lg md:text-xl">Categorias de Saídas</CardTitle>
        </CardHeader>
        <CardContent className="p-4 md:p-6 pt-0">
          <p className="text-sm md:text-base text-muted-foreground">
