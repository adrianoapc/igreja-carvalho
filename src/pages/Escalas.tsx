...
export default function Escalas() {
  ...
  const isConfirmado = (pessoaId: string, cultoId: string) => {
    return (
      escalas.find((e) => e.pessoa_id === pessoaId && e.evento_id === cultoId)
        ?.confirmado || false
    );
  };
            ...
            <CardTitle className="text-sm md:text-base flex items-center gap-2 flex-wrap">
              {timeAtual && (
                <div
                  ...
                  style={{
                    backgroundColor: timeAtual.cor || "hsl(var(--primary))",
                  }}
                />
              )}
                ...
                <thead>
                  <tr className="border-b bg-muted/50">
                    ...
                    {cultos.map((culto) => (
                      <th
                        key={culto.id}
                        className="p-2 md:p-3 text-center font-semibold min-w-[80px] md:min-w-[100px]"
                      >
                        <div className="text-muted-foreground text-xs">
                          {format(parseISO(culto.data_evento), "EEE", {
                            locale: ptBR,
                          })}
                        </div>
                    ...
                    <th className="p-2 md:p-3 text-center font-semibold min-w-[60px]">
                      Total
                    </th>
                  </tr>
                </thead>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="p-2 md:p-3 text-center">
                          <Badge
                            variant={totalEscalas > 0 ? "default" : "secondary"}
                            className="text-xs"
                          >
                            {totalEscalas}
                          </Badge>
