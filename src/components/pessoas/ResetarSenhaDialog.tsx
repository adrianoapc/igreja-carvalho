...
export function ResetarSenhaDialog({
  ...
  const handleResetarSenha = async () => {
    ...
    try {
      ...
      // Chamar Edge Function para resetar senha (método recomendado pelo Supabase)
      ...
      setResultado({
        sucesso: true,
        mensagem: `Senha resetada para ${pessoaNome}. Nova senha temporária gerada: ${senhaTemporaria}`,
      });

      toast({
        title: "Senha resetada",
        description: "O usuário deverá mudar a senha no próximo acesso.",
      });
      ...
      <Drawer open={isOpen} onOpenChange={onOpenChange}>
        <DrawerContent>
          <DrawerHeader>
            ...
            <DrawerDescription>
              Resete a senha de {pessoaNome} e marque para trocar no próximo
              acesso.
            </DrawerDescription>
          </DrawerHeader>
