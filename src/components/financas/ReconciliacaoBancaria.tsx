    ...
    <Card className="shadow-soft">
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="text-lg">Reconciliação de Contas</CardTitle>
          <Button onClick={reconciliarTodas} disabled={reconciliando} size="sm">
            <RefreshCw
              className={`w-4 h-4 mr-2 ${reconciliando ? "animate-spin" : ""}`}
            />
            Reconciliar Todas
          </Button>
        </div>
          ...
          <div className="p-3 bg-orange-100 dark:bg-orange-900/20 rounded-lg flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-orange-700 dark:text-orange-400 mt-1">
                O saldo registrado não corresponde ao calculado a partir das
                transações
              </p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-3 gap-3 text-sm">
                <div>
                  ...
                  <p className="font-semibold">
                    {formatValue(conta.saldoRegistrado)}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-muted-foreground mb-1">
                  ...
                  <p className="font-semibold">
                    {formatValue(conta.saldoCalculado)}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-muted-foreground mb-1">
                  ...
                  <p
                    className={`font-semibold ${
                      conta.hasDiferenca ? "text-orange-600" : "text-green-600"
                    }`}
                  >
